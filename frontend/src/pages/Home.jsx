  ...
  return (
    <div className="bg-cosset-cream">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-light tracking-wider">Last Chance</h2>
            <div className="flex gap-2">
              <button
          ...
          <div className="text-center mt-8">
            <Link to="/sale" className="text-sm tracking-wider underline hover:text-[#9b8676] transition-colors">
              View all
            </Link>
          </div>
        </div>
      ...
      <section className="py-12 border-y border-gray-200 overflow-hidden">
        <h3 className="text-center text-sm tracking-wider mb-8 text-gray-500">In the Press</h3>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-light tracking-wider text-center mb-12">EDITOR'S CURATION</h2>
      ...
      <section className="py-16 bg-[#f5f1ed]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl font-light tracking-wider mb-6">About Us</h2>
